...
extension ImageResource {
    ...
    static let destPin = ImageResource(name: "dest-pin", bundle: resourceBundle)

    /// The "drop" asset catalog image resource.
    static let drop = ImageResource(name: "drop", bundle: resourceBundle)
    ...
    static let temperatureSensor = ImageResource(name: "temperature-sensor", bundle: resourceBundle)

    /// The "thermometer" asset catalog image resource.
    static let thermometer = ImageResource(name: "thermometer", bundle: resourceBundle)
