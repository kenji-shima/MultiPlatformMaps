...
__attribute__((swift_name("Daily")))
@interface SharedDaily : SharedBase
- (instancetype)initWithTime:(NSArray<NSString *> *)time temperature_2m_max:(NSArray<SharedDouble *> *)temperature_2m_max temperature_2m_min:(NSArray<SharedDouble *> *)temperature_2m_min precipitation_probability_min:(NSArray<SharedDouble *> *)precipitation_probability_min precipitation_probability_max:(NSArray<SharedDouble *> *)precipitation_probability_max precipitation_probability_mean:(NSArray<SharedDouble *> *)precipitation_probability_mean wind_speed_10m_max:(NSArray<SharedDouble *> *)wind_speed_10m_max sunrise:(NSArray<NSString *> *)sunrise sunset:(NSArray<NSString *> *)sunset __attribute__((swift_name("init(time:temperature_2m_max:temperature_2m_min:precipitation_probability_min:precipitation_probability_max:precipitation_probability_mean:wind_speed_10m_max:sunrise:sunset:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) SharedDailyCompanion *companion __attribute__((swift_name("companion")));
- (SharedDaily *)doCopyTime:(NSArray<NSString *> *)time temperature_2m_max:(NSArray<SharedDouble *> *)temperature_2m_max temperature_2m_min:(NSArray<SharedDouble *> *)temperature_2m_min precipitation_probability_min:(NSArray<SharedDouble *> *)precipitation_probability_min precipitation_probability_max:(NSArray<SharedDouble *> *)precipitation_probability_max precipitation_probability_mean:(NSArray<SharedDouble *> *)precipitation_probability_mean wind_speed_10m_max:(NSArray<SharedDouble *> *)wind_speed_10m_max sunrise:(NSArray<NSString *> *)sunrise sunset:(NSArray<NSString *> *)sunset __attribute__((swift_name("doCopy(time:temperature_2m_max:temperature_2m_min:precipitation_probability_min:precipitation_probability_max:precipitation_probability_mean:wind_speed_10m_max:sunrise:sunset:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) NSArray<SharedDouble *> *precipitation_probability_max __attribute__((swift_name("precipitation_probability_max")));
@property (readonly) NSArray<SharedDouble *> *precipitation_probability_mean __attribute__((swift_name("precipitation_probability_mean")));
@property (readonly) NSArray<SharedDouble *> *precipitation_probability_min __attribute__((swift_name("precipitation_probability_min")));
@property (readonly) NSArray<NSString *> *sunrise __attribute__((swift_name("sunrise")));
@property (readonly) NSArray<NSString *> *sunset __attribute__((swift_name("sunset")));
@property (readonly) NSArray<SharedDouble *> *temperature_2m_max __attribute__((swift_name("temperature_2m_max")));
@property (readonly) NSArray<SharedDouble *> *temperature_2m_min __attribute__((swift_name("temperature_2m_min")));
@property (readonly) NSArray<NSString *> *time __attribute__((swift_name("time")));
@property (readonly) NSArray<SharedDouble *> *wind_speed_10m_max __attribute__((swift_name("wind_speed_10m_max")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("Daily.Companion")))
@interface SharedDailyCompanion : SharedBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SharedDailyCompanion *shared __attribute__((swift_name("shared")));
...
*/
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("DailyUnits")))
@interface SharedDailyUnits : SharedBase
- (instancetype)initWithTime:(NSString *)time temperature_2m_max:(NSString *)temperature_2m_max temperature_2m_min:(NSString *)temperature_2m_min precipitation_probability_min:(NSString *)precipitation_probability_min precipitation_probability_max:(NSString *)precipitation_probability_max precipitation_probability_mean:(NSString *)precipitation_probability_mean wind_speed_10m_max:(NSString *)wind_speed_10m_max sunrise:(NSString *)sunrise sunset:(NSString *)sunset __attribute__((swift_name("init(time:temperature_2m_max:temperature_2m_min:precipitation_probability_min:precipitation_probability_max:precipitation_probability_mean:wind_speed_10m_max:sunrise:sunset:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) SharedDailyUnitsCompanion *companion __attribute__((swift_name("companion")));
- (SharedDailyUnits *)doCopyTime:(NSString *)time temperature_2m_max:(NSString *)temperature_2m_max temperature_2m_min:(NSString *)temperature_2m_min precipitation_probability_min:(NSString *)precipitation_probability_min precipitation_probability_max:(NSString *)precipitation_probability_max precipitation_probability_mean:(NSString *)precipitation_probability_mean wind_speed_10m_max:(NSString *)wind_speed_10m_max sunrise:(NSString *)sunrise sunset:(NSString *)sunset __attribute__((swift_name("doCopy(time:temperature_2m_max:temperature_2m_min:precipitation_probability_min:precipitation_probability_max:precipitation_probability_mean:wind_speed_10m_max:sunrise:sunset:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) NSString *precipitation_probability_max __attribute__((swift_name("precipitation_probability_max")));
@property (readonly) NSString *precipitation_probability_mean __attribute__((swift_name("precipitation_probability_mean")));
@property (readonly) NSString *precipitation_probability_min __attribute__((swift_name("precipitation_probability_min")));
@property (readonly) NSString *sunrise __attribute__((swift_name("sunrise")));
@property (readonly) NSString *sunset __attribute__((swift_name("sunset")));
@property (readonly) NSString *temperature_2m_max __attribute__((swift_name("temperature_2m_max")));
@property (readonly) NSString *temperature_2m_min __attribute__((swift_name("temperature_2m_min")));
@property (readonly) NSString *time __attribute__((swift_name("time")));
@property (readonly) NSString *wind_speed_10m_max __attribute__((swift_name("wind_speed_10m_max")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("DailyUnits.Companion")))
@interface SharedDailyUnitsCompanion : SharedBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SharedDailyUnitsCompanion *shared __attribute__((swift_name("shared")));
- (id<SharedKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
@end
...
@interface SharedFeature : SharedBase
- (instancetype)initWithBbox:(NSArray<SharedDouble *> *)bbox geometry:(SharedGeometry *)geometry properties:(SharedProperties *)properties __attribute__((swift_name("init(bbox:geometry:properties:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) SharedFeatureCompanion *companion __attribute__((swift_name("companion")));
- (SharedFeature *)doCopyBbox:(NSArray<SharedDouble *> *)bbox geometry:(SharedGeometry *)geometry properties:(SharedProperties *)properties __attribute__((swift_name("doCopy(bbox:geometry:properties:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) NSArray<SharedDouble *> *bbox __attribute__((swift_name("bbox")));
@property (readonly) SharedGeometry *geometry __attribute__((swift_name("geometry")));
@property (readonly) SharedProperties *properties __attribute__((swift_name("properties")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("Feature.Companion")))
@interface SharedFeatureCompanion : SharedBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SharedFeatureCompanion *shared __attribute__((swift_name("shared")));
- (id<SharedKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
@end
...
@interface SharedForecast : SharedBase
- (instancetype)initWithLatitude:(double)latitude longitude:(double)longitude generationtime_ms:(double)generationtime_ms utc_offset_seconds:(int32_t)utc_offset_seconds timezone:(NSString *)timezone timezone_abbreviation:(NSString *)timezone_abbreviation elevation:(double)elevation daily_units:(SharedDailyUnits *)daily_units daily:(SharedDaily *)daily __attribute__((swift_name("init(latitude:longitude:generationtime_ms:utc_offset_seconds:timezone:timezone_abbreviation:elevation:daily_units:daily:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) SharedForecastCompanion *companion __attribute__((swift_name("companion")));
- (SharedForecast *)doCopyLatitude:(double)latitude longitude:(double)longitude generationtime_ms:(double)generationtime_ms utc_offset_seconds:(int32_t)utc_offset_seconds timezone:(NSString *)timezone timezone_abbreviation:(NSString *)timezone_abbreviation elevation:(double)elevation daily_units:(SharedDailyUnits *)daily_units daily:(SharedDaily *)daily __attribute__((swift_name("doCopy(latitude:longitude:generationtime_ms:utc_offset_seconds:timezone:timezone_abbreviation:elevation:daily_units:daily:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) SharedDaily *daily __attribute__((swift_name("daily")));
@property (readonly) SharedDailyUnits *daily_units __attribute__((swift_name("daily_units")));
@property (readonly) double elevation __attribute__((swift_name("elevation")));
@property (readonly) double generationtime_ms __attribute__((swift_name("generationtime_ms")));
...
@property (readonly) NSString *timezone_abbreviation __attribute__((swift_name("timezone_abbreviation")));
@property (readonly) int32_t utc_offset_seconds __attribute__((swift_name("utc_offset_seconds")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("Forecast.Companion")))
@interface SharedForecastCompanion : SharedBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SharedForecastCompanion *shared __attribute__((swift_name("shared")));
- (id<SharedKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("ForecastFormatted")))
@interface SharedForecastFormatted : SharedBase
- (instancetype)initWithForecast:(SharedForecast *)forecast geocode:(SharedGeocode *)geocode __attribute__((swift_name("init(forecast:geocode:)"))) __attribute__((objc_designated_initializer));
- (SharedForecastFormatted *)doCopyForecast:(SharedForecast *)forecast geocode:(SharedGeocode *)geocode __attribute__((swift_name("doCopy(forecast:geocode:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property NSArray<NSString *> *dateList __attribute__((swift_name("dateList")));
@property (readonly) SharedForecast *forecast __attribute__((swift_name("forecast")));
@property (readonly) SharedGeocode *geocode __attribute__((swift_name("geocode")));
@property NSString *place __attribute__((swift_name("place")));
@property NSArray<NSString *> *precipitationList __attribute__((swift_name("precipitationList")));
@property NSArray<NSString *> *temperatureList __attribute__((swift_name("temperatureList")));
@end
...
@interface SharedGeocode : SharedBase
- (instancetype)initWithFeatures:(NSArray<SharedFeature *> *)features __attribute__((swift_name("init(features:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) SharedGeocodeCompanion *companion __attribute__((swift_name("companion")));
- (SharedGeocode *)doCopyFeatures:(NSArray<SharedFeature *> *)features __attribute__((swift_name("doCopy(features:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) NSArray<SharedFeature *> *features __attribute__((swift_name("features")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("Geocode.Companion")))
@interface SharedGeocodeCompanion : SharedBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SharedGeocodeCompanion *shared __attribute__((swift_name("shared")));
- (id<SharedKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
@end
...
@property (class, readonly, getter=companion) SharedNetworkServiceCompanion *companion __attribute__((swift_name("companion")));

/**
 * @note This method converts instances of CancellationException to errors.
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)asyncGetAbstractUrl:(NSString *)url completionHandler:(void (^)(id _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("asyncGetAbstract(url:completionHandler:)")));
- (void)asyncGetWithHandlerAbstractUrl:(NSString *)url completionHandler:(void (^)(id _Nullable, SharedKotlinException * _Nullable))completionHandler __attribute__((swift_name("asyncGetWithHandlerAbstract(url:completionHandler:)")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("Geocoding")))
@interface SharedGeocoding : SharedNetworkService
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer)) __attribute__((unavailable));
+ (instancetype)new __attribute__((unavailable));
+ (instancetype)geocoding __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SharedGeocoding *shared __attribute__((swift_name("shared")));

/**
 * @note This method converts instances of CancellationException to errors.
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)asyncGetLat:(double)lat lng:(double)lng accessToken:(NSString *)accessToken completionHandler:(void (^)(SharedGeocode * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("asyncGet(lat:lng:accessToken:completionHandler:)")));
- (void)asyncGetWithHandlerLat:(double)lat lng:(double)lng accessToken:(NSString *)accessToken completionHandler:(void (^)(SharedGeocode * _Nullable, SharedKotlinException * _Nullable))completionHandler __attribute__((swift_name("asyncGetWithHandler(lat:lng:accessToken:completionHandler:)")));
...
*/
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("Geometry")))
@interface SharedGeometry : SharedBase
- (instancetype)initWithType:(NSString *)type coordinates:(NSArray<SharedDouble *> *)coordinates __attribute__((swift_name("init(type:coordinates:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) SharedGeometryCompanion *companion __attribute__((swift_name("companion")));
- (SharedGeometry *)doCopyType:(NSString *)type coordinates:(NSArray<SharedDouble *> *)coordinates __attribute__((swift_name("doCopy(type:coordinates:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) NSArray<SharedDouble *> *coordinates __attribute__((swift_name("coordinates")));
@property (readonly) NSString *type __attribute__((swift_name("type")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("Geometry.Companion")))
@interface SharedGeometryCompanion : SharedBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SharedGeometryCompanion *shared __attribute__((swift_name("shared")));
- (id<SharedKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
@end
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("NetworkService.Companion")))
@interface SharedNetworkServiceCompanion : SharedBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SharedNetworkServiceCompanion *shared __attribute__((swift_name("shared")));
...
- (instancetype)initWithFeature_name:(NSString *)feature_name matching_name:(NSString *)matching_name highlighted_name:(NSString *)highlighted_name description:(NSString *)description place_name:(NSString *)place_name id:(NSString *)id place_type:(NSArray<NSString *> *)place_type __attribute__((swift_name("init(feature_name:matching_name:highlighted_name:description:place_name:id:place_type:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) SharedPropertiesCompanion *companion __attribute__((swift_name("companion")));
- (SharedProperties *)doCopyFeature_name:(NSString *)feature_name matching_name:(NSString *)matching_name highlighted_name:(NSString *)highlighted_name description:(NSString *)description place_name:(NSString *)place_name id:(NSString *)id place_type:(NSArray<NSString *> *)place_type __attribute__((swift_name("doCopy(feature_name:matching_name:highlighted_name:description:place_name:id:place_type:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) NSString *description_ __attribute__((swift_name("description_")));
@property (readonly) NSString *feature_name __attribute__((swift_name("feature_name")));
@property (readonly) NSString *highlighted_name __attribute__((swift_name("highlighted_name")));
@property (readonly) NSString *id __attribute__((swift_name("id")));
@property (readonly) NSString *matching_name __attribute__((swift_name("matching_name")));
@property (readonly) NSString *place_name __attribute__((swift_name("place_name")));
@property (readonly) NSArray<NSString *> *place_type __attribute__((swift_name("place_type")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("Properties.Companion")))
@interface SharedPropertiesCompanion : SharedBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SharedPropertiesCompanion *shared __attribute__((swift_name("shared")));
- (id<SharedKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
@end
...
- (NSString *)formatDateStringInputDateString:(NSString * _Nullable)inputDateString __attribute__((swift_name("formatDateString(inputDateString:)")));
@property (readonly, getter=doInitZoom) double initZoom __attribute__((swift_name("initZoom")));
@property (readonly) double latitude __attribute__((swift_name("latitude")));
@property (readonly) double longitude __attribute__((swift_name("longitude")));
@end
...
@interface SharedWeatherForecast : SharedNetworkService
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer)) __attribute__((unavailable));
+ (instancetype)new __attribute__((unavailable));
+ (instancetype)weatherForecast __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SharedWeatherForecast *shared __attribute__((swift_name("shared")));

/**
 * @note This method converts instances of CancellationException to errors.
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)asyncGetLat:(double)lat lng:(double)lng completionHandler:(void (^)(SharedForecast * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("asyncGet(lat:lng:completionHandler:)")));
- (void)asyncGetFormattedWithHandlerLat:(double)lat lng:(double)lng accessToken:(NSString *)accessToken completionHandler:(void (^)(SharedForecastFormatted * _Nullable, SharedKotlinException * _Nullable))completionHandler __attribute__((swift_name("asyncGetFormattedWithHandler(lat:lng:accessToken:completionHandler:)")));
- (void)asyncGetWithHandlerLat:(double)lat lng:(double)lng completionHandler:(void (^)(SharedForecast * _Nullable, SharedKotlinException * _Nullable))completionHandler __attribute__((swift_name("asyncGetWithHandler(lat:lng:completionHandler:)")));
@property (readonly) NSString *baseUrl __attribute__((swift_name("baseUrl")));
@end
