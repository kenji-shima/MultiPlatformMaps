...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    /**
     * Returns the group of libraries at mapbox
     */
    public MapboxLibraryAccessors getMapbox() { return laccForMapboxLibraryAccessors; }
    ...
    public static class KtorClientLibraryAccessors extends SubDependencyFactory {
        ...
        public KtorClientLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
             ...
             * This dependency was declared in catalog libs.versions.toml
             */
            public Provider<MinimalExternalModuleDependency> getWebsockets() { return create("ktor.client.websockets"); }

    }

    public static class MapboxLibraryAccessors extends SubDependencyFactory {
        private final MapboxMapsLibraryAccessors laccForMapboxMapsLibraryAccessors = new MapboxMapsLibraryAccessors(owner);

        public MapboxLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Returns the group of libraries at mapbox.maps
         */
        public MapboxMapsLibraryAccessors getMaps() { return laccForMapboxMapsLibraryAccessors; }

    }

    public static class MapboxMapsLibraryAccessors extends SubDependencyFactory {

        public MapboxMapsLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

            /**
             * Creates a dependency provider for android (com.mapbox.maps:android)
             * This dependency was declared in catalog libs.versions.toml
             */
            public Provider<MinimalExternalModuleDependency> getAndroid() { return create("mapbox.maps.android"); }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        private final MapboxVersionAccessors vaccForMapboxVersionAccessors = new MapboxVersionAccessors(providers, config);
        public VersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }
            ...
            /**
             * Returns the version associated to this alias: serializable (1.6.20)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            public Provider<String> getSerializable() { return getVersion("serializable"); }
        ...
        /**
         * Returns the group of versions at versions.mapbox
         */
        public MapboxVersionAccessors getMapbox() { return vaccForMapboxVersionAccessors; }
    ...
    public static class MapboxVersionAccessors extends VersionFactory  {

        public MapboxVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

            /**
             * Returns the version associated to this alias: mapbox.sdk (11.0.0)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            public Provider<String> getSdk() { return getVersion("mapbox.sdk"); }
    ...
    public static class PluginAccessors extends PluginFactory {
        ...
        public PluginAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }
            ...
            /**
             * Creates a plugin provider for androidSerialization to the plugin id 'org.jetbrains.kotlin.plugin.serialization'
             * This plugin was declared in catalog libs.versions.toml
             */
            public Provider<PluginDependency> getAndroidSerialization() { return createPlugin("androidSerialization"); }
