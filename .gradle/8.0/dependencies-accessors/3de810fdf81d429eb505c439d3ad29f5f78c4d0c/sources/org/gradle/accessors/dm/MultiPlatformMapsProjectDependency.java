...
@NonNullApi
public class MultiPlatformMapsProjectDependency extends DelegatingProjectDependency {

    @Inject
    public MultiPlatformMapsProjectDependency(TypeSafeProjectDependencyFactory factory, ProjectDependencyInternal delegate) {
